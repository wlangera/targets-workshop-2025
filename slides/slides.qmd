...
- Create a **targets** pipeline
  ...
  3. Join the dataframe and grid resources together
  4. Visualise the number of bird species per grid cell
...
- Use **ggplot2** together with **sf** for visualisation

## Challenge 2

- Built further on your pipeline from *Challenge 1*
  - Filter the data
    - 2020
