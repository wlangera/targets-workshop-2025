...
We create functions to get the most common species and visualise their presence in 2020.
...
Create R Markdown report you want to render and add `tar_render()` to the pipeline
